-- Animations and Bezier Curves configuration
...
hl.curve("superQuick", {
    type = "bezier",
    points = { {0.05, 0.9}, {0.15, 1} }
})

-- Animation rules mapping
...
hl.animation({ leaf = "specialWorkspace", enabled = true, speed = 3.0, bezier = "superQuick", style = "slidevert" })
